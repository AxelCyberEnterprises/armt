  ...
  return (
    <div className="landing__container">
      ...
      <div className="landing__container-section1">
        ...
        <div className="landing__container-section1_right item" variants={item}>
          <img
            src="/hero.png"
      ...
      <div className="landing__container-section2">
        <div className="landing__container-section2_column column1">
        ...
        <div className="landing__container-section2_column column2" >
        ...
        <div className="landing__container-section2_column column3">
