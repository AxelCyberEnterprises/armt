    ...
    <div className="privacy__container">
      ...
      <div className="privacy__container-body">
        ...
        <div className="privacy__container-body_section3">
          ...
          <p className="privacy-text">
            We implement various security measures to ensure the protection of
        ...
        <div className="privacy__container-body_section1">
          ...
          <p className="privacy-text">
            ...
            are small files placed on your device that help us analyze web
            traffic and customize our services. You can choose to accept or
        ...
        <div className="privacy__container-body_section1">
          ...
          <p className="privacy-text">
            ...
            you to read their privacy policies when you visit them.
          </p>
        </div>
