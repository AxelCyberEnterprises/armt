    ...
    <div className="careers__container">
      ...
      <div className="careers__container-section4">
        <div className="careers__container-section4_extras">
          ...
          <Extras
            extrasHead="Need help applying?"
            extrasBody="Access our detailed preparation guides for smooth and successful application instructions"
          />
        </div>
        <div className="careers__container-section4_extras">
          <img src="/career-graduate.png" alt="" />
          <Extras
            extrasHead="Graduates & placements"
            extrasBody="Apply now for our graduate schemes and internships"
          />
        </div>
      </div>
