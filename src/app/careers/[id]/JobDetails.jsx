  ...
  return (
    <div className="job__container">
      ...
      <div className="job__container-body">
        ...
        <div>{modal && <Modal toggleModal={toggleModal} />}</div>
        <div className="job__container-body_section3">
          <h1>Overview</h1>
          <p>
            The {jobData.jobDescription} will be responsible for planning,
            designing, and overseeing construction and maintenance of rail mass
            transit systems. This includes working on projects that involve
            track alignment, station design, tunnels, bridges, and other related
            structures. The ideal candidate will have a strong background in
            civil engineering, excellent problem-solving skills, and the ability
        ...
        <div className="job__container-body_section5">
          ...
          <div className="job__container-body_section5-paragraph">
            ...
            <p>
              Knowledge of sustainability practices and green building
              standards.{" "}
            </p>
            <p>
              Familiarity with local and international rail standards and
              regulations.
            </p>
          </div>
        </div>
        <div className="job__container-body_section5">
          ...
          <div className="job__container-body_section5-paragraph">
            ...
            <p>
              May require occasional evening or weekend work to meet project
              deadlines or address urgent issues.
            </p>
            <p>
              Travel may be required for site inspections, meetings, and project
              coordination.
            </p>
          </div>
        </div>
