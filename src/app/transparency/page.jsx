    ...
    <div className="transparency__container">
      ...
      <div className="transparency__container-body">
        <div className="transparency__container-body_section1">
          ...
          <p className="transparency-text">At ARMT, we believe in maintaining transparency with our customers. This page is dedicated to providing clear and detailed information about our operations, policies, and practices. We are committed to ensuring that you have a complete understanding of how we operate and serve you.</p>
        </div>
        ...
        <div className="transparency__container-body_section2">
          ...
          <p className="transparency-text">Our ticket pricing is determined based on several factors, including</p>
          <div className="transparency-bulet">
          ...
          <p className="transparency-text margin">We strive to offer competitive pricing and occasional promotions to provide value to our customers.</p>
        </div>

        <div className="transparency__container-body_section2">
          <h2 className="transparency-header">Cancellation Policy</h2>
          <p className="transparency-text">We understand that plans can change. Our refund and cancellation policy is designed to be fair and transparent:</p>
          <div className="transparency-bulet">
        ...
        <div className="transparency__container-body_section2">
          ...
          <p className="transparency-text">Your safety is our top priority. We implement stringent safety and security measures:</p>
          <div className="transparency-bulet">
        ...
        <div className="transparency__container-body_section2">
          ...
          <p className="transparency-text">We are committed to protecting your personal information:</p>
          <div className="transparency-bulet">
          ...
          <p className="transparency-text margin">For more information, please refer to our Privacy Policy.</p>
        </div>

        <div className="transparency__container-body_section2">
          <h2 className="transparency-header">Environmental Responsibility</h2>
          <p className="transparency-text">We are dedicated to minimizing our environmental impact:</p>
          <div className="transparency-bulet">
        ...
        <div className="transparency__container-body_section2">
          ...
          <p className="transparency-text">Your feedback is invaluable to us. We encourage you to share your experiences and suggestions:</p>
          <div className="transparency-bulet">
        ...
        <div className="transparency__container-body_section2">
          ...
          <p className="transparency-text">We publish regular reports to keep you informed about our performance and initiatives:</p>
          <div className="transparency-bulet">
        ...
        <div className="transparency__container-body_section1">
          ...
          <p className="transparency-text">If you have any questions or concerns about our Privacy Policy or the handling of your personal information, please contact us at:</p>
        </div>
