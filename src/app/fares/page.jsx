    ...
    <>
      ...
      <main className="fares-container">
        <section className="mt-8 sm:mt-12">
          ...
          <p className="text-xl text-[#2d3039] font-bold mb-3">
            How much does it cost and how to move around Abuja
          </p>
          <p className="text-base text-[#595959] mb-4">
            Find out the best ticket cost to get to your destination in Abuja
            and how to use cowie cards, view fares and best route
          </p>
          <div className="sm:w-[75%] rounded mb-8 p-4 pt-8 sm:p-8 bg-[#eeeeee]">
            <div className="flex flex-col sm:flex-row mb-8 gap-y-2">
              <div className="flex-1 mb-8 sm:mb-0">
                <div className="mb-4">
                  <p className="inline text-white p-2 bg-[#5a5eb7]">
                    Departures
                  </p>
                </div>
                <input
            ...
            <div className="flex gap-2 itmes-center justify-center flex-row">
              <button className="bg-[#149145] p-2 text-white rounded ">
                Cost
              </button>
              <input
          ...
          <div className="flex flex-col gap-8 sm:items-center sm:flex-row mb-8">
            <div className="flex-1">
              <div className="p-4 bg-[#eeeeee]">
                <p className="text-xl font-[#2d3039] font-bold mb-2">
                  Cowrie account
                </p>
                <p className="text-base text-[#595959] mb-2">
                  Top up omline, view your payment and journey history and
                  request refunds when necesaary
                </p>
                <button className="rounded sm:ml-[5%] p-2 text-white text-base bg-[#149145] w-[90%]">
                  Sign up
                </button>
              </div>
            </div>
            ...
            <div className="rounded p-4 flex-1 bg-[#eeeeee]">
              <p className="text-xl text-[#2d3039] font-bold mb-3">
                Contact us about safety issues
              </p>
              ...
              <div className="mb-3">
                ...
                <p className="text-base text-[#2d3039]">
                  <a className="text-[#149145] text-base" href="#">
                    Charges apply
                  </a>{" "}
                  +234 802 369 9037
                </p>
          ...
          <div className="mb-12 flex gap-4 sm:flex-row flex-col">
            <Extras
              ...
              extrasBody={
                "There are different ways to pay for your travel and whereto get travel tickets"
              }
            />
            <Extras
            ...
            <Extras
              ...
              extrasBody={
                "How to get a refund,replace your cowrie card if misplaced or stolen"
              }
            />
          </div>
        </section>
